...
export const words: Word[] = [
  ...
  },
  {
    id: '15',
    word: 'Potestatif',
    definition: 'Qui dépend de la seule volonté d\'une des parties contractantes, rendant une obligation ou une clause potentiellement nulle.',
    exampleSentence: 'Cette clause potestative était contestable car elle ne liait que l\'une des parties.',
    category: 'adjectif',
    register: 'soutenu'
  },
  {
    id: '16',
    word: 'Antépénultième',
    definition: 'Qui précède l\'avant-dernier ; troisième en partant de la fin.',
    exampleSentence: 'L\'accent tonique tombe sur la syllabe antépénultième dans de nombreux mots latins.',
    category: 'adjectif',
    register: 'soutenu'
  },
  {
    id: '17',
    word: 'Whimsical',
    definition: 'Fantaisiste, capricieux, qui obéit à l\'imagination plutôt qu\'à la logique.',
    exampleSentence: 'Son style whimsical séduisait par ses associations d\'idées inattendues.',
    category: 'adjectif',
    register: 'soutenu'
  },
  {
  ...
  },
  {
    id: '21',
    word: 'Léonine',
    definition: 'Se dit d\'une clause ou d\'une convention injuste qui avantage excessivement l\'une des parties au détriment de l\'autre.',
    exampleSentence: 'Le contrat comportait une clause léonine qui laissait le franchisé sans recours.',
    category: 'adjectif',
    register: 'soutenu'
  },
  {
  ...
  },
  {
    id: '23',
    word: 'Exsangue',
    definition: 'Qui a perdu beaucoup de sang et est d\'une pâleur extrême ; au figuré, épuisé, vidé de toute vitalité.',
    exampleSentence: 'Il ressortit exsangue de la réunion, incapable de prononcer un mot.',
    category: 'adjectif',
    register: 'soutenu'
  },
  {
    id: '24',
    word: 'Pavoiser',
    definition: 'Orner de drapeaux et de pavillons ; au figuré, manifester sa joie ou sa fierté de manière ostentatoire.',
    exampleSentence: 'Après la victoire, toute la ville s\'est mise à pavoiser sans retenue.',
    category: 'verbe',
    register: 'soutenu'
  },
  {
  ...
  },
  {
    id: '26',
    word: 'Dithyrambique',
    definition: 'Qui exprime une admiration enthousiaste et exagérée ; élogieux à l\'excès.',
    exampleSentence: 'La critique fut dithyrambique, mais le film laissa le public indifférent.',
    category: 'adjectif',
    register: 'soutenu'
  },
  {
  ...
  },
  {
    id: '28',
    word: 'Placide',
    definition: 'D\'une sérénité calme et imperturbable, qui ne s\'émeut pas facilement.',
    exampleSentence: 'Elle restait placide face aux provocations, ce qui déstabilisait ses adversaires.',
    category: 'adjectif',
    register: 'courant'
  },
  {
    id: '29',
    word: 'Liminaire',
    definition: 'Qui se trouve au seuil ou au début d\'un texte, d\'un ouvrage ; introductif, préliminaire.',
    exampleSentence: 'La note liminaire de l\'ouvrage résumait les intentions de l\'auteur.',
    category: 'adjectif',
    register: 'soutenu'
  },
  {
    id: '30',
    word: 'Baguenaudant',
    definition: 'Qui flâne sans but, se promène en perdant son temps à des futilités (participe de baguenauder).',
    exampleSentence: 'Il passa l\'après-midi à baguenauder dans les rues du vieux quartier.',
    category: 'verbe',
    register: 'soutenu'
  },
  {
    id: '31',
    word: 'Pateliner',
    definition: 'Se montrer doucereux, mielleux et flatteur dans le but d\'obtenir quelque chose.',
    exampleSentence: 'Il pateline tellement qu\'on ne sait plus distinguer sa sincérité de ses arrière-pensées.',
    category: 'verbe',
    register: 'courant'
  },
  {
  ...
  },
  {
    id: '39',
    word: 'Aréneux',
    definition: 'Qui contient du sable, qui est de nature sableuse.',
    exampleSentence: 'Ce sol aréneux drainait bien mais retenait peu les nutriments.',
    category: 'adjectif',
    register: 'soutenu'
  },
  {
  ...
  },
  {
    id: '42',
    word: 'Vespéral',
    definition: 'Qui appartient au soir, qui a rapport au crépuscule ou aux vêpres.',
    exampleSentence: 'Une lumière vespérale dorée envahissait lentement la salle de lecture.',
    category: 'adjectif',
    register: 'soutenu'
  },
  {
  ...
  },
  {
    id: '46',
    word: 'Escamoter',
    definition: 'Faire disparaître adroitement ; éviter habilement une question, passer quelque chose sous silence.',
    exampleSentence: 'Il avait l\'art d\'escamoter les questions gênantes avec un sourire désarmant.',
    category: 'verbe',
    register: 'courant'
  },
  {
  ...
  },
  {
    id: '48',
    word: 'Fluer',
    definition: 'S\'écouler doucement et continûment ; se propager de manière fluide et naturelle.',
    exampleSentence: 'Les mots fluaient de sa plume sans effort apparent.',
    category: 'verbe',
    register: 'soutenu'
  },
  {
  ...
  },
  {
    id: '51',
    word: 'Enkysté',
    definition: 'Enfermé dans un kyste ou une enveloppe ; au figuré, isolé, replié sur lui-même, difficile à déloger.',
    exampleSentence: 'Le conflit, enkysté depuis des années, semblait impossible à résoudre.',
    category: 'adjectif',
    register: 'soutenu'
  },
  {
  ...
  },
  {
    id: '54',
    word: 'Préhensible',
    definition: 'Qui peut être saisi, agrippé ; susceptible d\'être appréhendé mentalement.',
    exampleSentence: 'L\'outil, conçu pour être préhensible à une main, facilitait le travail de précision.',
    category: 'adjectif',
    register: 'soutenu'
  },
  {
    id: '55',
    word: 'Kafkaïen',
    definition: 'Caractéristique de l\'univers de Kafka ; se dit d\'une situation absurde, oppressante et bureaucratique sans issue apparente.',
    exampleSentence: 'Il vécut un calvaire kafkaïen pour faire valider un simple document administratif.',
    category: 'adjectif',
    register: 'courant'
  },
  {
  ...
  {
    id: '62',
    word: 'Ne pas être aux pièces',
    definition: 'Ne pas être pressé, ne pas travailler à la tâche ; prendre son temps sans se soucier du chronomètre.',
    exampleSentence: 'Allez, on n\'est pas aux pièces ! Finissons ce repas tranquillement.',
    category: 'verbe',
    register: 'courant'
  },
  {
  ...
  },
  {
    id: '64',
    word: 'Sentient',
    definition: 'Capable de ressentir des sensations, d\'éprouver des émotions et de percevoir le monde subjectivement.',
    exampleSentence: 'La question de savoir si les pieuvres sont des êtres sentients fait débat parmi les scientifiques.',
    category: 'adjectif',
    register: 'soutenu'
  },
  {
  ...
  },
  {
    ...
    definition: 'Faire un repas excellent, se régaler de bons mets (à ne pas confondre avec "faire bonne figure").',
    exampleSentence: 'À chaque passage dans ce restaurant, ils faisaient bonne chère sans se ruiner.',
    category: 'verbe',
    register: 'courant'
  },
  {
  ...
  },
  {
    id: '73',
    word: 'Syncrétique',
    definition: 'Qui mêle des éléments issus de systèmes différents — philosophiques, religieux ou culturels — en une synthèse.',
    exampleSentence: 'Sa pensée syncrétique empruntait autant au stoïcisme qu\'au bouddhisme.',
    category: 'adjectif',
    register: 'soutenu'
  },
  {
    id: '74',
    word: 'Dispendieux',
    definition: 'Qui entraîne de grandes dépenses, qui coûte très cher.',
    exampleSentence: 'Ce style de vie dispendieux finit par épuiser ses économies en quelques années.',
    category: 'adjectif',
    register: 'courant'
  },
  {
    id: '75',
    word: 'Syndrome de Tako-Tsubo',
  ...
  },
  {
    id: '81',
    word: 'Héler',
    definition: 'Appeler de loin à voix haute pour attirer l\'attention de quelqu\'un.',
    exampleSentence: 'Elle héla un taxi depuis le trottoir d\'en face.',
    category: 'verbe',
    register: 'courant'
  },
  {
  ...
  },
  {
    id: '84',
    word: 'Exondée',
    definition: 'Qui n\'est plus submergé, qui a émergé hors de l\'eau.',
    exampleSentence: 'La plaine exondée après la décrue laissait apparaître des terres fertiles.',
    category: 'adjectif',
    register: 'soutenu'
  },
  {
  ...
  },
  {
    id: '90',
    word: 'Panoptique',
    definition: 'Système de surveillance total permettant d\'observer tout depuis un point central sans être vu ; relatif au contrôle généralisé.',
    exampleSentence: 'Les réseaux sociaux ont créé une forme de panoptique numérique dont peu d\'individus ont conscience.',
    category: 'adjectif',
    register: 'soutenu'
  },
  {
  ...
  },
  {
    id: '92',
    word: 'Épistémique',
    definition: 'Relatif à la connaissance et à ses fondements ; qui concerne les conditions et les limites du savoir.',
    exampleSentence: 'Cette question épistémique — comment sait-on ce qu\'on sait ? — traversait toute son œuvre.',
    category: 'adjectif',
    register: 'soutenu'
  },
  {
    id: '93',
    word: 'Processus stochastique',
  ...
  },
  {
    ...
    definition: 'Prendre une décision irréversible et audacieuse ; dépasser le point de non-retour en s\'engageant définitivement.',
    exampleSentence: 'En signant cet accord, ils franchissaient le Rubicon : il n\'était plus possible de reculer.',
    category: 'verbe',
    register: 'courant'
  },
  {
  ...
  },
  {
    id: '100',
    word: "D'airain",
    definition: 'Fait d\'un métal très dur (le bronze) ; au figuré, d\'une dureté, d\'une résistance et d\'une inflexibilité absolues.',
    exampleSentence: "Sa volonté d'airain lui permit de surmonter des épreuves que d'autres n'auraient pas supportées.",
    category: 'adjectif',
    register: 'soutenu'
  },
  {
